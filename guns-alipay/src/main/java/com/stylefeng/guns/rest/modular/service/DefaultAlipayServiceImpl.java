...
public class DefaultAlipayServiceImpl implements AlipayServiceApi {
    ...
    public AlipayResultVO getOrderStatus(String orderId) {
        ...
        //mock降级测试，本地存根和本地伪装只能捕获RpcException的异常，一般springboot+dubbo的项目更适合采用Hystrix进行服务降级，
        //如果是spring+dubbo可以考虑本地伪装进行服务降级。
//        try {
//            Thread.sleep(5000);
...
//        }
    ...
    public String trade_precreate(String orderId) {
        ...
        String operatorId = "huyufan";

        // (必填) 商户门店编号，通过门店号和商家后台可以配置精准到门店的折扣信息，详询支付宝技术支持
        String storeId = "huyufan";
...
//        goodsDetailList.add(goods2);
        ...
        switch (result.getTradeStatus()) {
            case SUCCESS:
                ...
                // 需要修改为运行机器上的路径
                filePath = String.format("C:/Users/Spyssor.Hu/Desktop/qrcode/qr-%s.png",
